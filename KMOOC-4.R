...
# 원도표
par(mfrow=c(1,2))
pie(smart.prop[1,],main="Male")
pie(smart.prop[2,],main="Female")
...
row.names(ttnbar) <- c("first class","second class","third class","attendant")
colnames(ttnbar) <- c("male","child","female")
